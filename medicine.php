            ...
            if ($statement = $con->prepare($query)) {
                if ($statement->bind_param("sisisisi", $medicineName, $dosageQty, $dosageUnit, $milligramQty, $milligramUnit, $frequencyQty, $frequencyUnit, $user_id)) {
                    ...
                    if ($statement->execute()) {
                        $success[] = "Medicine Saved Succesfully";
                    } else {
                        $errors[] = "Error Saving Medicine";
                    }
                } else {
...
<?php set_header("Add New Medicine");?>
<div class="container">
    <div class="row mt-5">

        <div class="col-md-8 offset-md-2">
            <h5 class="display-5 mb-4">Add New Medicine</h5>
...
?>
            <form action="" method="post">
                ...
                <input type="submit" name="saveMedicine" value="Save New Medicine"
