...
<body>
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 offset-md-2 p-5" style="margin: 110px auto;">
...
?>
                <form action="" method="post" autocomplete="off">
                    <h4 class="text-uppercase">Enter your credentials to login</h4>
                    ...
                    <input type="submit" value="Login" class="form-control btn btn-primary text-white my-3"
                        name="submit">
                </form>
                <p> <a href="registration.php">Sign up to create an account</a></p>
            </div>
